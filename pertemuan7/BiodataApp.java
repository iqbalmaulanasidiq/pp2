...
public class BiodataApp extends JFrame { // kelas BiodataApp yang merupakan turunan dari JFrame
    ...
    public BiodataApp() { // membuat fungsi BiodataApp
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (confirmation == JOptionPane.YES_OPTION) {
                    ...
                    if (nama.isEmpty()) { // jika nama kosong maka tampilkan pesan dialog
                        JOptionPane.showMessageDialog(BiodataApp.this, "Nama tidak boleh kosong", "Peringatan", JOptionPane.WARNING_MESSAGE);
                    } else if (telepon.isEmpty()) {
                        JOptionPane.showMessageDialog(BiodataApp.this, "Nomor hp tidak boleh kosong", "Peringatan", JOptionPane.WARNING_MESSAGE);
                    } else if (alamat.isEmpty()) {
                        JOptionPane.showMessageDialog(BiodataApp.this, "Alamat tidak boleh kosong", "Peringatan", JOptionPane.WARNING_MESSAGE);
